...
const DriverSignUpFragment = () => <SignUpForm />;
...
const SignUpFormBase = (props) => {
  ...
  const onSubmit = (event) => {
    ...
    const isDriver = details.isDriver;
    const username = details.username;
    const auth = ROLES.DRIVER;
    ...
    if (isDriver) {
      roles[ROLES.DRIVER] = ROLES.DRIVER;
    }
...
export default DriverSignUpFragment;
export { SignUpForm };
