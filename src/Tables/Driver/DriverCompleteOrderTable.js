...
import { loadSubCompleteOrder } from "../../Store/Action/DriverAdmin/SubCompleteOrderAction";
...
class DriverCompleteOrderTable extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(DriverCompleteOrderTable);
