...
import { loadStaff } from "../../../Store/Action/Admin/Users/StaffAction";
...
class StaffTableFragment extends Component {
  constructor(props) {
    super(props);
...
const mapDispatchToProps = (dispatch) => {
  return {
    loadStaff: (onSuccess, onError) =>
      dispatch(loadStaff(onSuccess, onError)),
  };
};
