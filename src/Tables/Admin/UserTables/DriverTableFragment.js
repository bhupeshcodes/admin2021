...
import { loadDriver } from "../../../Store/Action/Admin/Users/DriverAction";
...
class DriverTableFragment extends Component {
  constructor(props) {
    super(props);
...
const mapDispatchToProps = (dispatch) => {
  return {
    loadDriver: (onSuccess, onError) =>
      dispatch(loadDriver(onSuccess, onError)),
  };
};
