...
import {
  loadRejectedOrder,
} from "../../../Store/Action/Admin/Dashboard/RejectedOrderAction";
...
class RejectedOrderTable extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.props.loadRejectedOrder(
      () => {
        this.setState({
          loading: false,
          CompletionDate: new Date(this.props.RejectedOrder.CompletionDate),
        });
      },
      () => {
        //error
...
RejectedOrderTable.contextType = mainContext;

const mapStateToProps = (state) => {
  return {
    RejectedOrder: state.RejectedOrder,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    loadRejectedOrder: (onSuccess, onError) =>
      dispatch(loadRejectedOrder(onSuccess, onError)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(RejectedOrderTable);
